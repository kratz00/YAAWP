...
public class ActionDisplayVarious extends ActionDisplay {
	...
	public static boolean sendCirclesSilent(Context context,
			ArrayList<Circle> circles, boolean centerOnData)
					throws RequiredVersionMissingException {
	...
	private static boolean sendCirclesSilent(String action, Context context, 
			ArrayList<Circle> circles, boolean callImport, boolean centerOnData)
					throws RequiredVersionMissingException {
		// check data
		...
		return sendData(action, context, intent, callImport, centerOnData, 242);
	}
